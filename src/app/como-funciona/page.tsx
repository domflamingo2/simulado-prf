    ...
    const prefetchComponents = () => {
      ...
      links.forEach((link) => {
        link.addEventListener("mouseenter", () => {
          ...
          import("./components/BeneficiosSection");
        });
      });
    };
